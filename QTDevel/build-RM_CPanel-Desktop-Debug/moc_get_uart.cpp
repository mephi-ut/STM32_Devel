...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Get_Uart_t, stringdata) + ofs \
...
const QMetaObject Get_Uart::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Get_Uart.data,
      qt_meta_data_Get_Uart,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Get_Uart.stringdata))
